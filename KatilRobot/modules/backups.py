...
# from KatilRobot.modules.sql import warns_sql as warnssql
import KatilRobot.modules.sql.blacklist_sql as blacklistsql

# from KatilRobot.modules.sql import cust_filters_sql as filtersql
# import KatilRobot.modules.sql.welcome_sql as welcsql
import KatilRobot.modules.sql.locks_sql as locksql
import KatilRobot.modules.sql.notes_sql as sql

# from KatilRobot.modules.rules import get_rules
import KatilRobot.modules.sql.rules_sql as rulessql
from KatilRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from KatilRobot.__main__ import DATA_IMPORT
from KatilRobot.modules.connection import connected
from KatilRobot.modules.helper_funcs.alternate import typing_action
from KatilRobot.modules.helper_funcs.chat_status import user_admin
from KatilRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("KatilRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KatilRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KatilRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KatilRobot{}.backup".format(chat_id))  # Cleaning file
