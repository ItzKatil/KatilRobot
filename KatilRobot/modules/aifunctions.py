...
from KatilRobot import telethn
from KatilRobot.events import register


@register(pattern="Katil (.*)")
async def hmm(event):
    ...
    if "no no" in result:
        pro = "I am fairly found and I was made by @ItzKatil."
        try:
