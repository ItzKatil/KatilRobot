...
import KatilRobot.modules.sql.chatbot_sql as sql
from KatilRobot import BOT_ID, BOT_NAME, BOT_USERNAME, dispatcher
from KatilRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from KatilRobot.modules.log_channel import gloggable
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        if "Tera baap Kon" in text:
            message.reply_text("Mera Baap @ItzKatil hai")
        elif "Who is you father?" in text:
            message.reply_text("My father is @ItzKatil.")
        elif "Prerna" in text:
            ...
            if response:
                ...
                message.reply_text("I'm sorry, Mere baap @ItzKatil na ya sab nhi sikhaya h moko.")
