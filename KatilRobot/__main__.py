...
from KatilRobot import pbot

import KatilRobot.modules.no_sql.users_db as sql
from KatilRobot import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
    OWNER_ID,
...
from KatilRobot.modules import ALL_MODULES
from KatilRobot.modules.helper_funcs.chat_status import is_user_admin
from KatilRobot.modules.helper_funcs.misc import paginate_modules
...
╔═════۩۞Katil۞۩════╗
      
♥️═══[♥️ι ℓσνє уσυ ♥️](https://t.me/Itz_Kaatil)═══♥                                                                                                                                                                                                 
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="♥️му σƒƒιcє♥️", url=f"https://t.me/KatilBots"),
    ],
    [
        InlineKeyboardButton(text="♥️𝙎𝙪𝙥𝙚𝙧🔸𝙎𝙤𝙪𝙧𝙘𝙚♥️", callback_data="Katil_"),
    ],
]
...
1️⃣ **Contact Us:** Feel free to reach out to our dedicated team for more information or assistance. We're here to help! ✉️
   ...
   - Support Group: @Masti_Ke_Pathsala
   - Channel: @KatilBots
   - UPI ID: ItzKatil@ybl
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KatilRobot.modules." + module_name)
...
def Katil_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "Katil_":
        uptime = get_readable_time((time.time() - StartTime))
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="🥀ᴅᴇᴠᴇʟᴏᴩᴇʀ🥀", url=f"https://t.me/Itz_Kaatil"
                        ),
                        InlineKeyboardButton(
                            text="✨𝐑𝐄𝐏𝐎✨", 
							url="https://github.com/ItzKatil/KatilRobot",
                        ),
                    ],
					[
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="💗ᴜᴩᴅᴀᴛᴇs💓", url=f"https://t.me/Katilbots"
                        ),
					],
                    [
                        InlineKeyboardButton(text="♥️ вαϲк ♥️", callback_data="Katil_back"),
                    ],
                ]
            ),
        )
    elif query.data == "Katil_back":
        first_name = update.effective_user.first_name 
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [Katil](https://t.me/Itz_Kaatil)"
...
╔═════ஜ۩۞۩ஜ═════╗
  ...
  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝗞𝗔𝗧𝗜𝗟](https://t.me/Itz_Kaatil)♨️
...
""",reply_markup=x,
    ...
    about_callback_handler = CallbackQueryHandler(
        Katil_about_callback, pattern=r"Katil_", run_async=True
    ...
    LOGGER.info("🌱𝗞𝗔𝗧𝗜𝗟𝐁𝐎𝐓🌷𝐒𝐓𝐀𝐑𝐓𝐄𝐃🌺𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐔🌱\n\n╔═════ஜ۩۞۩ஜ════╗\n\n♨️𝗠𝗔𝗗𝗘 𝗕𝗬 𝗞𝗔𝗧𝗜𝗟♨️\n\n╚═════ஜ۩۞۩ஜ════╝")
